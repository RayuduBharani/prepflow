        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            <div className="space-y-2">
              ...
              {/* <CompanyLogo companyName={ComapanyName} name="companyId" /> */}
              <Input name="company" id="company" placeholder="Enter Company Name" className="border-muted" suppressContentEditableWarning={true} />
            </div>
            <div className="space-y-2">
