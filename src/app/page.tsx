...
const page = () => {
  return (
    // <BackgroundLines svgOptions={{duration : 3}} className="flex items-center justify-center w-full flex-col px-4 max-sm:h-full sm:h-full">
    ...
    // </BackgroundLines>
    <div className='py-[4rem]'>HomePage</div>
  )
}
