...
export const SOCIAL_LINKS: Developer[] = [
  {
    ...
    links: [
      ...
      { href: "https://instagram.com/cygnuxxs", icon: <Instagram />, hoverClass: "group-hover:bg-linear-to-r from-yellow-400 via-pink-500 to-purple-600" },
    ],
  },
  {
    name: "Rayudu Bharani",
    links: [
      ...
      { href: "mailto:ashok7075657409@gmail.com", icon: <Mail />, hoverClass: "hover:bg-black hover:text-white" },
      { href: "https://instagram.com/bharani_rayudu", icon: <Instagram />, hoverClass: "group-hover:bg-linear-to-r from-yellow-400 via-pink-500 to-purple-600" },
    ],
  },
];